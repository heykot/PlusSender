...
# ===================== ТЕПЛІ ТОНОВІ КОНСТАНТИ =====================
# Маленькі типові віджети, що повторюються в багатьох місцях інтерфейсу.
# Тримаємо тут — щоб мова була послідовна по всьому боту.
...
# «Підказка-приклад» — невеликий блок над полем вводу.
TIP_PREFIX = "💡  <i>Підказка:</i>"
EXAMPLE_PREFIX = "📋  <i>Приклад:</i>"
NEXT_PREFIX = "👉  <b>Далі:</b>"
NICE_TRY = "🌟  <i>Молодець!</i>"
DONE_BADGE = "✨  <b>Готово!</b>"

# Дружні «м'які» помилки — щоб менше лякати новачка.
SOFT_ERROR_PREFIX = "🤔  <b>Хм, щось не так</b>"
SOFT_RETRY = "<i>Спробуйте ще раз — все вийде!</i>"
